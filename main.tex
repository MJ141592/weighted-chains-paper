...
\begin{abstract}
    ...
    The results of this paper have been formalised in Lean 4.
\end{abstract}
...
\begin{equation*}
    \big\{X \subseteq [n]: \vert X\vert = \big\lfloor \frac{n}{2} \big\rfloor\big\} \ \text{and} \ \big\{X \subseteq [n]: \vert X\vert = \big\lceil \frac{n}{2} \big\rceil\big\}
\end{equation*}
...
\begin{equation*}
    A_1 := \big\{X \subseteq [n]: \vert X\vert  = \big\lfloor\frac{n}{2}\big\rfloor\big\}
    \ \text{and} \
    A_2 := \big\{X \subseteq [n]: \vert X\vert  = \big\lceil\frac{n}{2}\big\rceil\big\}
\end{equation*}
