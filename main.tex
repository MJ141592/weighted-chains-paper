...
\begin{proof}
    ...
    $2:$ Let us now suppose that $n>k$.
        ...
        $2.2:$ We recall that if one of $(a-1, n-a-c, c),$ $(a, n-a-c-1, c)$ and $(a, n-a-c, c-1)$ is not a proper lower inner type, then we must have: $a=c$, $a=c+k-1$, $b=0$ or $c=0$. We now consider these case by case.
        \begin{caseindent}
