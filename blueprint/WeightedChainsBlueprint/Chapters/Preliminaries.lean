...
%%%
source := paperSource "Definition 2.1" 198 204
%%%
...
%%%
source := paperSource "Definition 2.2" 206 210
%%%
...
%%%
source := paperSource "Definition 2.3" 220 225
%%%
...
%%%
source := paperSource "Definition 2.4" 227 231
%%%
...
%%%
source := paperSource "Definition 2.5" 239 246
%%%
...
%%%
source := paperSource "Definition 2.6" 252 257
%%%
...
%%%
source := paperSource "Definition 2.7" 272 282
%%%
...
%%%
source := paperSource "Definition 2.8" 286 290
%%%
...
%%%
source := paperSource "Definition 2.9" 293 297
%%%
...
:::definition "wc:def:type" (parent := "paper-preliminaries") (lean := "WeightedChains.Cube.typeOf, WeightedChains.Cube.sum_typeOf, WeightedChains.Ternary.TypeCounts, WeightedChains.Ternary.TypeCounts.ofVertex") (autoDeps := true) (tags := "semantic-review-pending, direct, encoding, numbered")
%%%
source := paperSource "Definition 2.10" 309 317
%%%

The type of a point records, for each symbol $`j \in \{0,\ldots,d\}`, the
number of coordinates equal to $`j`; these $`d+1` counts sum to $`n`.

*Semantic review:* pending. *Correspondence:* direct and encoding. Lean uses the
...
%%%
source := paperSource "Good-chain residue intersection" 259 270
%%%
