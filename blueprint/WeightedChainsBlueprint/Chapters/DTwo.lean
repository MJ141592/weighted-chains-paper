...
*Semantic review:* pending. *Correspondence:* factored and encoding. Lean gives
a constructive $`d=2` encoding rather than an iff characterization of arbitrary
chains.
:::
